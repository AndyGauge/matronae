...
// quote), body (textual and interpretive context), citation (verse
...
const raw = [
  ...
  },
  {
    ...
    eli5: 'The verse that settles it for many churches: "I do not permit a woman to teach or have authority over a man." Three debates: whether the present-tense verb means "this one time" or "always"; what the rare word for "authority" actually meant; and whether the reason given ("Adam was made first") is a universal principle or a local argument against a specific wrong teaching.'
  }
];
